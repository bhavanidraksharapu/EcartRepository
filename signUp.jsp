                    ...
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="register" method="post">
                                ...
                                <h6 style="color:Red;">${requestScope.errr}</h6> 
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" name="uname" value="" placeholder="Name" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" name="upassword" value="" placeholder="Password" required>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" name="umailid" placeholder="Email" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="email" class="form-control" name="umobileno" placeholder="Mobile No" value="">
                                    </div>
                                    <div class="col-12">
